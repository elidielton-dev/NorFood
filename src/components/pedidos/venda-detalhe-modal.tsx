...
import { fetchVendaDetalheServer } from "@/lib/api/pedidos/pedido-detalhe.functions";
import { formatBRL } from "@/lib/shared/db";
import { resolveProductImage } from "@/lib/loja/cardapio";
import { formatNotaNumero, shouldShowNeighborhood, simplifyNotaRejection } from "@/lib/delivery/order-display";
import {
  labelFormaPagamento,
  labelStatusVenda,
  statusVendaTone,
...
import { StatusPill } from "@/components/painel/gestao-ui";
