...
export function getTenantSidebarSections(
  ...
  const sections: SidebarSection[] = [
    ...
    },
    {
      title: "Configuracoes",
      items: [
        item(tenantSlug, "configuracoes", "Central de configuracoes", Settings2, true),
        item(tenantSlug, "configuracoes/loja", "Loja e aparencia", Palette),
        item(tenantSlug, "configuracoes/horarios", "Horarios", Clock),
        item(tenantSlug, "configuracoes/mesas", "Mesas do salao", Utensils),
        item(tenantSlug, "configuracoes/pagamentos", "Pagamentos", CreditCard),
        item(tenantSlug, "configuracoes/equipe", "Equipe", UserCog),
      ],
    },
    {
      title: "Atendimento",
