...
const PAINEL_TO_TENANT_SEGMENTS: Record<string, string> = {
  ...
  "/estabelecimento/horarios": "estabelecimento/horarios",
  "/estabelecimento/pagamentos": "estabelecimento/pagamentos",
  "/estabelecimento/visual": "estabelecimento/visual",
  "/configuracoes": "configuracoes/integracoes",
