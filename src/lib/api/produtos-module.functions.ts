...
import { resolveStaffTenantId } from "@/lib/api/auth-helpers.server";
import {
...
import { uploadProductImage } from "@/lib/api/product-image.server";
import type { ModuleStore, ProductCategory, ProductRecord } from "@/lib/produtos-module";
