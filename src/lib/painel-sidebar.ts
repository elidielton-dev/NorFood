...
export const sidebarSections: SidebarSection[] = [
  ...
  },
  {
    title: "Configuracoes",
    items: [
      { to: "/painel/configuracoes", label: "Central de configuracoes", icon: Settings2, exact: true },
      { to: "/painel/configuracoes/loja", label: "Loja e aparência", icon: Home },
      { to: "/painel/configuracoes/horarios", label: "Horarios", icon: Clock },
      { to: "/painel/configuracoes/mesas", label: "Mesas do salao", icon: ChefHat },
      { to: "/painel/configuracoes/pagamentos", label: "Pagamentos", icon: CreditCard },
      { to: "/painel/configuracoes/equipe", label: "Equipe", icon: Users },
    ],
  },
  {
    title: "Atendimento",
    items: [
      ...
      { to: "/painel/atendimento/configuracoes", label: "WhatsApp", icon: MessageCircle },
    ],
  },
  {
    title: "Financeiro",
